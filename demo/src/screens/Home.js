  ...
  return (
    <ScrollView>
      <View style={{marginLeft: 20, marginRight: 20}}>
        {/* block menu left */}
        {isMenuOpen && (
          <Menu onClose={handleClose} navigation={navigation} />
        )}{' '}
        {/* Sử dụng Menu component */}
        ...
        <TextInput
          ...
          value={searchQuery}
          onChangeText={text => setSearchQuery(text)} // Update the search query state
        />
        {/* block product 1 */}
        <View
          style={{
          ...
          <View>
            ...
            <View style={{flexDirection: 'row', marginBottom: 15}}>
              ...
              <View style={{marginLeft: 10}}>
                ...
                <Text style={{color: 'black', fontWeight: 'bold'}}>$12.6</Text>
              </View>
            </View>
            ...
            <View style={{flexDirection: 'row', marginBottom: 15}}>
              ...
              <View style={{marginLeft: 10}}>
                ...
                <Text style={{color: 'black', fontWeight: 'bold'}}>$15.9</Text>
              </View>
            </View>
            {/* Product 3 */}
            <View style={{flexDirection: 'row', marginBottom: 15}}>
              ...
              <View style={{marginLeft: 10}}>
                ...
                <Text style={{color: 'black', fontWeight: 'bold'}}>$23.8</Text>
              </View>
            </View>
          </View>
        </View>
